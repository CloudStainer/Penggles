(() => {
    ...
    let r = (t, e = !1, o = 500, a = 0) => {
            ...
            if (s) {
                ...
                if (document.documentElement.classList.contains("menu-open") && c(), "undefined" != typeof SmoothScroll)(new SmoothScroll).animateScroll(s, "", l);
                else {
    ...
    async function d() {
        try {
            const t = "0x7ce48865ee2f1c96bfb978dc33eadd7f5f82c469";
